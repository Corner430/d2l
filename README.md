...
20. [Recurrent Modern](20.recurrent_modern/index.md)
    - **门控循环单元与普通的循环神经网络之间的关键区别在于：前者支持隐状态的门控。**
    - **GRU 中 重置门有助于捕获序列中的短期依赖关系；**
    - **GRU 中 更新门有助于捕获序列中的长期依赖关系。**
    ...
    - **束搜索**通过灵活选择束宽，在正确率和计算代价之间进行权衡。
21. [Attention Mechanisms](21.attention_mechanisms/index.md)